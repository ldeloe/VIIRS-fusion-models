...
train_options = {'train_variables': SCENE_VARIABLES,
                 ...
                 'train_list_path': 'datalists/test_train.json', #test_train.json', #
                 'val_path': 'datalists/test_val.json', #
                 'test_path': 'datalists/test_test.json', #

                 'train_viirs': 'datalists/train_viirs.json', #
                 'test_viirs': 'datalists/test_viirs.json', #test_viirs.json',#
                 'validate_viirs': 'datalists/validate_viirs.json', #validate_viirs.json',#
