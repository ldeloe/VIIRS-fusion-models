...
python launch.py '/home/lcbdeloe/projects/def-ka3scott/lcbdeloe/VIIRS-fusion-models/configs/unet_reg_ai4arctic.py' --wandb-project='ai4arctic-plus-viirs-unet-hpt'
