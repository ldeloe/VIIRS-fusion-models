...
#python launch.py $1 --wandb-project='hpt-optims'

python launch.py "/home/lcbdeloe/projects/def-ka3scott/lcbdeloe/VIIRS-fusion-models/configs/adamw_small_arch.py" --wandb-project='hpt-optims'
#python launch.py "/home/lcbdeloe/projects/def-ka3scott/lcbdeloe/VIIRS-fusion-models/configs/opt_adamw_base.py" --wandb-project='extended-test'
