...
python launch.py "/home/lcbdeloe/projects/def-ka3scott/lcbdeloe/VIIRS-fusion-models/configs/wr_30.py" --wandb-project='hpt-warm-restart'
#python launch.py $1 --wandb-project='hpt-warm-restart'
